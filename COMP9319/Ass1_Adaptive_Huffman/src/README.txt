...
"AhEncodeFunctions.cpp" file, which has the bulk of the classes in.
I'm following the pseudo code from Vitter's paper that was supplied 
very closely, except I use a normal "binary tree" instead of the "floating 
tree". In order to do this, I'm implemented a "switching" mechanism
(similar to bubble sort) to do the "slide and increment" and maintained
the parents and siblings of each node as they slide.
...
"BlockContainer" class, which has two separate list for leaf and
