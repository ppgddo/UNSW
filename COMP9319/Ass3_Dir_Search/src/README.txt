...
"index file" code is still there, but is disabled with hardcoded flags. I felt like I designed
a pretty good index file, but I didn't have enough time to fix the bug.
